...
void MyGLWidget::pintarPatricio(char cas)
{
...
void MyGLWidget::setColorFocus ()
{
    colorFocus = glm::vec3(1.0, 1.0, 1.0);
    glUniform3fv (colFoc, 1, &colorFocus[0]);
}

void MyGLWidget::setPosicioFocus ()
{
...
void MyGLWidget::carregaShaders ()
{
  ...
  colFoc = glGetUniformLocation (program->programId(), "colFocus");
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(TG, glm::vec3(moureX, -0.375, 0));
...
void MyGLWidget::modelTransformVaca ()
{
  ...
  TG = glm::rotate(TG, gir, glm::vec3(0, 0, 1));
...
void MyGLWidget::projectTransform ()
{
  ...
  Proj = glm::perspective(M_PI/FOV, 1.0, 1.0, 5.*radiEsc);
...
void MyGLWidget::calculaCapsaModelCow ()
{
  ...
  // Vaca d'alçada 0.5 (la z indica la alçada)
