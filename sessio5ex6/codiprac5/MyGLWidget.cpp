...
{
    // Transformacio que només s'aplica al terra perque no es mogui quan es facin altres transformacions
  // Matriu de transformació de model
  glm::mat4 transform;
...
{
    /*
     * Recalcula el window perque no hi hagi deformació a l'escena
     */
...
void MyGLWidget::calculaCapsaModel ()
{
  ...
  // Vector amb les coordenades del centre del Patricio
